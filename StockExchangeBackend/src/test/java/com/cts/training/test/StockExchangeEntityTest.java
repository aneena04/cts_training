...
public class StockExchangeEntityTest {
	...
	public void testGetAllStockExchanges() {
		...
		assertEquals(12, stockExchanges.size());
	}
...
//		assertEquals(stockExchange.getContractAddress(), stockExchangeDAO.getStockExchangeById(1).getContactAddress());
//	}
	...
	public void testUpdateStockExchangeSuccess() {
		StockExchangeEntity stockExchange = stockExchangeDAO.getStockExchangeById(5);
